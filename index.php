...
<style>
    ...
    /* Lesbare Größen und Farben – DYNAMISCH */
    ...
    h4 { font-size: clamp(22px, 4vw, 28px); margin: 6px 0; color: #333; }
    ...
    h6 { font-size: clamp(18px, 3.5vw, 26px); margin-bottom: 6px; color: #444; }
    p  { font-size: clamp(18px, 3vw, 24px); margin: 6px 0; color: #333; }
